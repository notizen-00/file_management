...
<head>
    ...
    <!-- Favicon -->
    <link rel="shortcut icon" href="<?php base_url('assets')?>/favicon.png" />
...
<body>
    ...
    <!-- ./ search sidebar -->
    <?php $this->load->view('layout/partial/navbar');?>
    <!-- ./ sidebars -->

    <!-- menu -->
    <?php $this->load->view('layout/partial/sidebar');?>
    <!-- ./  menu -->
    ...
    <div class="layout-wrapper">
        ...
        <!-- ./ content-footer -->
        <?=$this->load->view('layout/partial/footer')?>